...
BOT_TOKEN = environ.get('BOT_TOKEN', "5625295308:AAFe0OcRWRAFOfRIlcV5Oxm-qLFvQv_Hjt0")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5606411877 1802523258').split()]
