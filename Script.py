...
class script(object):
    ...
    START_TXT = environ.get("START_TXT", '''HELLO {} 👋🏻  𝙷𝙴𝙻𝙻𝙾 𝙰𝚔𝚊𝚜𝚑 👋🏻  𝙸 𝙰𝙼 𝙰𝙽 𝙰𝙳𝚅𝙰𝙽𝙲𝙴𝙳 𝙰𝚄𝚃𝙾-𝙵𝙸𝙻𝚃𝙴𝚁 𝙱𝙾𝚃. 𝚈𝙾𝚄 𝙲𝙰𝙽 𝚄𝚂𝙴 𝙰𝙽𝚈 𝚂𝙷𝙾𝚁𝚃𝙽𝙴𝚁 𝙸𝙽𝚃𝙾 𝙼𝙴 𝚃𝙷𝙴𝙽 𝙸 𝚆𝙸𝙻𝙻 𝙶𝙸𝚅𝙴 𝚈𝙾𝚄𝚁 𝙻𝙸𝙽𝙺𝚂 𝙸𝙽 𝚈𝙾𝚄𝚁 𝙶𝚁𝙾𝚄𝙿 𝙹𝚄𝚂𝚃 𝙰𝙳𝙳 𝙼𝙴 𝙸𝙽 𝚈𝙾𝚄𝚁 𝙶𝚁𝙾𝚄𝙿 𝙰𝙽𝙳 𝙼𝙰𝙺𝙴 𝙼𝙴 𝙰𝙳𝙼𝙸𝙽!👽</i>''')
    HELP_TXT = """ʜᴇʏ {}
